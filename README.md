...
I'm a Data Engineer working at Capital One. I'm automating processes and insights in Retail Bank by utilizing Python, Spark, SQL, and Javascript on platforms like Databricks and Snowflake. 
...
|[Formula 1 Race Predictions with AWS Lambda](https://github.com/markboeignk/Formula_1_Race_Predictions)|Automated serverless ML pipeline that predicts F1 race finishing positions using real-time weather data, historical performance metrics, and XGBoost models. Features event-driven orchestration, feature engineering with DuckDB, ONNX inference, and predictions stored in DynamoDB. </p> <b> Tech Stack:</b> Python, XGBoost, DuckDB, ONNX, AWS Lambda, S3, DynamoDB, EventBridge, Open-Meteo API|
|[Video Transcription and Summarizer](https://github.com/markboenigk/Video-Summarizer)|Telegram bot to extract information from videos (Instagram Reels)  by transcribing and summarizing them. The bot is hosted on AWS Lambdas and utilizes the Telegram API, Whisper API to transcribe the videos, and the OpenAI API to summarizes the content. </p> <b> Tech Stack:</b> Python, Telegram API, AWS Lambda, Dynamo DB, OpenAI Whisper, Open AI Response API, AWS Secret Manager|
|[Airport Flight Data Analysis](https://github.com/markboenigk/Airport-Flight-Analysis/tree/main)|Analyzes flight data from an airport for a specific day(s). It utilizes the Flightaware Aero API to fetch the data, transforms the data and then creates KPIs and tables as output. It then creates a written report as a pdf file with the OpenAI Response API. </p> <b> Tech Stack:</b> Python, FlightAware API, OpenAI API, Plotly|
|[Msc Business Analytics Portfolio](https://github.com/markboenigk/Msc_Business_Analytics_Portfolio)|Various projects during the MSc in Business Analytics at Hult International Business School <li> ML Classification Project - Predict Customer Churn <li> Star Wars Text Adventure Game <li> Prisoners Dilemma Game </p> <b> Tech Stack:</b> Python (Pandas, Sci-kit learn)|




![Metrics](https://metrics.lecoq.io/markboenigk?template=repository&base=header,activity,community,repositories,metadata&config.timezone=America/New_York)
